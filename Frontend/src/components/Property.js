      ...
      <Container minW="80%" alignItems="center">
        ...
        >
          ...
          >
            ...
            <GridItem rowSpan={1}>
              <Text color="#58152E" fontWeight="bold" fontSize="16px">
                Rent Inclusions and Ameneties:
              </Text>
            </GridItem>
            ...
            <GridItem rowSpan={1}>
              <Text fontWeight="bold" fontSize="20px">
                {property.min_month_stay} months
              </Text>
            </GridItem>
            <GridItem rowSpan={1} colSpan={2}></GridItem>

            <GridItem rowSpan={1}>
              <Text color="#58152E" fontWeight="bold" fontSize="15px">
                Contact details:
              </Text>
            </GridItem>
