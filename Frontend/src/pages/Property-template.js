import { Box, Image, Badge, ChakraProvider, Text, Container, Link, Divider, Grid, GridItem } from '@chakra-ui/react'
    ...
    <ChakraProvider theme={Theme}>
        <Container minW='80%' mt='20' fontWeight='bold' as='h2' mb='20'>
            ...
            <GridItem rowSpan={2} colSpan={2}>
                <Image borderRadius='lg' src={property.imageUrl} />
            </GridItem>
            <GridItem rowSpan={1}>
                <Image borderRadius='lg' src={property.imageUrl} />
            </GridItem>
        ...
        <Container minW='80%' alignItems='center'>
            <Box borderRadius='lg' overflow='hidden' boxShadow='0px 0px 15px 1px #dbdbdb' padding='10'>
                ...
                <GridItem rowSpan={4}>
                <Image boxSize='150px' borderRadius='full' src={property.imageUrl} />
                </GridItem>
